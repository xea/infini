...
public:
    ...
    GLEWRenderObject* translate(float x, float y, float z) override;

    GLEWRenderObject* rotate(float angle, float x, float y, float z) override;

    GLEWRenderObject* scale(float x, float y, float z) override;
};
